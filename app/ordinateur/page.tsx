  ...
  return (
    ...
    w-36 bg-heliotrope-300 border-heliotrope-300 text-s font-bold mt-[20px] "
     ...
     bg-yellow-400 border-yellow-400 w-[140px] ml-[120px]"
            ...
            <div className="mt-[50px] ">
              <p className="ml-[40px]">1 599,00€</p>
              <button
                className="text-black h-12
    w-36 bg-heliotrope-300 border-heliotrope-300 text-s font-bold mt-[20px] "
              >
     ...
     bg-yellow-400 border-yellow-400 w-[140px] ml-[120px]"
            ...
            <div className="mt-[50px] ">
              <p className="ml-[40px]">1 829,00€</p>
              <button
                className="text-black h-12
    w-36 bg-heliotrope-300 border-heliotrope-300 text-s font-bold mt-[20px] "
              >
    ...
    w-36 bg-heliotrope-300 border-heliotrope-300 text-s font-bold mt-[20px] "
     ...
     bg-yellow-400 border-yellow-400 w-[140px] ml-[120px]"
            ...
            <div className="mt-[50px] ">
              <p className="ml-[40px]">3 229,00€</p>
              <button
                className="text-black h-12
    w-36 bg-heliotrope-300 border-heliotrope-300 text-s font-bold mt-[20px] "
              >
     ...
     bg-yellow-400 border-yellow-400 w-[140px] ml-[120px]"
            ...
            <div className="mt-[50px] ">
              <p className="ml-[40px]">4 149,00€</p>
              <button
                className="text-black h-12
    w-36 bg-heliotrope-300 border-heliotrope-300 text-s font-bold mt-[20px] "
              >
      ...
      <div className="pl-[700px] mt-[50px] pb-[50px]">
        <Link href="/ordinateur2" className="text-red-600">
          2
        </Link>
      </div>
    </div>
